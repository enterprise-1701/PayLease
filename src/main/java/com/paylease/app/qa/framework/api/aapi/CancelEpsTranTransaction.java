...
public class CancelEpsTranTransaction extends AapiTransaction {

  private static final String ACTION_NAME = "CancelEPSTransaction";
  ...
  /**
   * Creates a CancelEpsTranTransaction transaction with the given element values.
   *
   * @param parameters Values for transaction-specific elements
   */
  public CancelEpsTranTransaction(HashMap<String, String> parameters) {
    super(parameters);
