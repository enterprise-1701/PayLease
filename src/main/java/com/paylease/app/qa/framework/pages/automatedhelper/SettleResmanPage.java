...
public class SettleResmanPage extends PageBase {

  private static final String URL = BASE_URL + "testing/automated_helper/settle_resman";
   ...
   */
  public void settleResmanTrans(String transactionId) {
