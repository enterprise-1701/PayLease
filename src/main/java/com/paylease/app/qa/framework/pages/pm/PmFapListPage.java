...
import com.paylease.app.qa.framework.components.datatable.PmViewFap.Columns;
import java.util.HashMap;
import org.openqa.selenium.By;

public class PmFapListPage extends ViewAutopays {

  private static final String URL = BASE_URL + "pm/fixed_autopay_list";
  ...
  public boolean pageIsLoaded() {
    ...
    return (titleText.equalsIgnoreCase("Fixed AutoPays") && !driver.findElements(
  ...
  public boolean hasRowMatchingData(String status, String startDate, String endDate,
      ...
      String debitDay, String freq, String accountNum, String amount) {
