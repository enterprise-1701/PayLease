...
import com.paylease.app.qa.framework.components.datatable.ResViewVap;
import com.paylease.app.qa.framework.components.datatable.ResViewVap.Columns;
import java.util.HashMap;

public class ResVapListPage extends ResViewAutopays {
  ...
  public boolean hasRowMatchingData(String status, String startDate, String endDate,
    ...
    dataTable = new ResViewVap(dataTableElement);
