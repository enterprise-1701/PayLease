...
import com.paylease.app.qa.framework.api.gapi.IssueCashPermCardTransaction;
import java.util.HashMap;

public class IssueCashPermCard extends BasicTestCase {
  ...
  /**
   * Create test case for IssueCashPermCard.
   *
   * @param payerReferenceId payerReferenceId of this test case in the request
   * @param summary summary of this test case
   * @param expectedResponse response expected to be returned by GAPI
   */
  public IssueCashPermCard(
  ...
  private IssueCashPermCard(
      String payerReferenceId, String summary, ExpectedResponse expectedResponse,
      String payerFirstName,
      String payerLastName, String cardNumber
  ) {
   ...
   */
  public static IssueCashPermCard createValid(
      String payerReferenceId, String summary, ExpectedResponse expectedResponse
  ) {
    IssueCashPermCard testCase = new IssueCashPermCard(payerReferenceId, summary, expectedResponse);
  ...
  public IssueCashPermCard setPayerFirstName(String payerFirstName) {
    this.payerFirstName = payerFirstName;
    return this;
  }

  public IssueCashPermCard setPayerLastName(String payerLastName) {
    this.payerLastName = payerLastName;
    return this;
  }

  public IssueCashPermCard setCardNumber(String cardNumber) {
    this.cardNumber = cardNumber;
    return this;
  }
  ...
  public void addTransaction(Request apiRequest) {
    ...
    parameters.put(IssueCashPermCardTransaction.PAYER_REFERENCE_ID, payerReferenceId);
    parameters.put(IssueCashPermCardTransaction.PAYER_FIRST_NAME, payerFirstName);
    parameters.put(IssueCashPermCardTransaction.PAYER_LAST_NAME, payerLastName);
    parameters.put(IssueCashPermCardTransaction.CARD_NUMBER, cardNumber);

    GapiTransaction transaction = new IssueCashPermCardTransaction(parameters);
