...
import com.paylease.app.qa.framework.api.gapi.IssueCashRentCardTransaction;
import java.util.HashMap;

public class IssueCashRentCard extends BasicTestCase {
  ...
  /**
   * Create test case for IssueCashRentCard.
   *
   ...
   */
  public static IssueCashRentCard createValid(
      String payerReferenceId, String summary, ExpectedResponse expectedResponse
  ) {
    IssueCashRentCard testCase = new IssueCashRentCard(payerReferenceId, summary, expectedResponse);
  ...
  public IssueCashRentCard setPayerFirstName(String payerFirstName) {
    this.payerFirstName = payerFirstName;
    return this;
  }

  public IssueCashRentCard setPayerLastName(String payerLastName) {
    this.payerLastName = payerLastName;
    return this;
  }
  ...
  public void addTransaction(Request apiRequest) {
    ...
    parameters.put(IssueCashRentCardTransaction.PAYER_REFERENCE_ID, payerReferenceId);
    parameters.put(IssueCashRentCardTransaction.PAYER_FIRST_NAME, payerFirstName);
    parameters.put(IssueCashRentCardTransaction.PAYER_LAST_NAME, payerLastName);

    GapiTransaction transaction = new IssueCashRentCardTransaction(parameters);
