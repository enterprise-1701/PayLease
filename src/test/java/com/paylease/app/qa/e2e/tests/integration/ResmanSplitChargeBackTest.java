...
import com.paylease.app.qa.testbase.dataproviders.ResmanSplitChargebackDataProvider;
import org.testng.Assert;
import org.testng.annotations.Test;

public class ResmanSplitChargeBackTest extends ScriptBase {

  private static final String REGION = "integration";
  private static final String FEATURE = "resmanSplitTransaction";

  @Test(dataProvider = "resmanSplitChargeback", dataProviderClass = ResmanSplitChargebackDataProvider.class, groups =
      {"e2e"}, retryAnalyzer = Retry.class)
  public void resmanSplitChargebackFlow(String testNum, String testCaseinfo, String testCase,
      String paymentType, String paymentUi, String[] expectedResults) {
    ...
    login.logInAdmin();
    chargeback(otpInfo[0]);
    reverseAdmin(otpInfo[0], paymentType, false);
  ...
  private void chargeback(String transId) {
    TransactionDetailPage transactionDetailPage = new TransactionDetailPage(transId);
    transactionDetailPage.open();
    transactionDetailPage.chargebackTrans();
  }
