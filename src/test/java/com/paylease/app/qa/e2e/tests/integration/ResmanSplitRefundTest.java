...
import com.paylease.app.qa.testbase.dataproviders.ResmanSplitRefundDataProvider;
import org.testng.Assert;
import org.testng.annotations.Test;

public class ResmanSplitRefundTest extends ScriptBase {

  private static final String REGION = "integration";
  private static final String FEATURE = "resmanSplitTransaction";

  @Test(dataProvider = "resmanSplitRefund", dataProviderClass = ResmanSplitRefundDataProvider.class, groups = {
      "e2e"}, retryAnalyzer = Retry.class)
  public void resmanSplitRefundFlow(String testNum, String testCaseinfo, String testCase,
