...
import com.paylease.app.qa.testbase.dataproviders.ResmanSplitReturnDataProvider;
import org.testng.Assert;
import org.testng.annotations.Test;

public class ResmanSplitReturnTest extends ScriptBase {

  private static final String REGION = "integration";
  private static final String FEATURE = "resmanSplitTransaction";

  @Test(dataProvider = "resmanSplitReturn", dataProviderClass = ResmanSplitReturnDataProvider.class, groups = {
      "e2e"}, retryAnalyzer = Retry.class)
  public void resmanSplitReturnFlow(String testNum, String testCaseinfo, String testCase,
    ...
    returnTransaction(otpInfo[0], partial);
  ...
  private void returnTransaction(String transId, boolean partial) {
    ...
    returnTransactionPage.returnTransaction(transId);
  }
